:- module(
  ...
  [
    ...
    rest_handler/2,   % +Req, :Goal_3
    rest_handler/5    % +Req, +HandleId, :Exists_1, :Instance_4, :Class_3
  ]
).
...
rest_exception0(MT, error(E,_)) :-
  rest_exception0(MT, E).
% HTML errors are generated by default.
...
%! rest_handler(+Req, :Goal_3) is det.
%
% Handle the given request
%
%   - in one of the given media types (MTs), prefering ones that
%     appear earlier in the list
%
%   - under the given Method

rest_handler(Req, Goal_3) :-
  http_accept(Req, MTs),
