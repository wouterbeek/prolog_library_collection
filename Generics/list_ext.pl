...
%
% @param List Then list from which elements are deleted.
% @param Deletes The list of element that are deleted.
% @param NewList The result of deleting the given elements from the given
%    list.
